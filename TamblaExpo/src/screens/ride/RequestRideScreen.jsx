 ...
 *
 * Visual map view with route polyline, ride option selection cards
 * (Standard, Tambula XL, Tambula Boda, Tambula Executive),
 * payment method selector, fare breakdown, and CTA.
 */
