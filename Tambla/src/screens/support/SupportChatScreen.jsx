...
const INITIAL_MESSAGES = [
  {
    id: 'm1',
    sender: 'agent',
    text: 'Hello Patrick! Brenda from Tambla Kampala Support here. How can I help you today?',
    time: '10:40 AM',
  },
  {
    id: 'm2',
  ...
  },
  {
    id: 'm3',
    sender: 'agent',
    text: 'Thanks for bringing this to our attention. I checked your account for TRIP-9842. The duplicate pending hold of UGX 12,000 has been released and refunded to your Tambla Wallet balance.',
    time: '10:44 AM',
  },
  {
    id: 'm4',
    ...
    >
      ...
      <View style={[styles.header, { paddingTop: insets.top + 6 }]}>
        ...
        <View style={styles.agentInfo}>
          ...
          <View>
            <Text style={styles.agentName}>Brenda N. (Tambla Support)</Text>
