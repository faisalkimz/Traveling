...
const RIDE_TYPES = [
  { id: 'std', title: 'Tambla Standard', capacity: '4 seats', fare: 'UGX 14,000', icon: 'car' },
  { id: 'xl', title: 'Tambla XL', capacity: '6 seats', fare: 'UGX 22,000', icon: 'bus' },
  { id: 'moto', title: 'Tambla Moto', capacity: '1 passenger', fare: 'UGX 6,000', icon: 'bicycle' },
];
