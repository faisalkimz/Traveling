...
const ShareTripScreen = ({ navigation, route }) => {
  ...
  const handleNativeShare = async () => {
    try {
      await Share.share({
        message: `I'm on my way in a Tambla ride with driver ${trip.driverName} (${trip.vehicle}, ${trip.plate}). Track my live trip to ${trip.destination}: ${trip.trackingUrl}`,
        title: 'Tambla Trip Tracking',
      });
    } catch (error) {
